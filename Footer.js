        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col">
              ...
              <ui className="list-unstyled">
                <li>{adr} Address : Bugle Rock Rd, Gandhi Bazaar, Basavanagudi, Bengaluru, Karnataka 560004</li>
                <li>{yah} E-mail : C2@gmail.com</li>
                <li>{call} Mobile : (+91)775-468-1234 - office</li>
              </ui>
            </div>
          </div>
          <hr />
